                ...
                <div class="login-form">
                  ...
                  <form class="user" @submit.prevent="InsertSupplier" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="exampleInputFirstName" required placeholder="Enter Shop Name" v-model="form.shopname">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="form-group" >
                      <button type="submit" class="btn btn-primary btn-block-left">Add Supplier</button>
                    </div>
                  </form>
